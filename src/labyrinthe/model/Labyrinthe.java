...
public class Labyrinthe {
    ...
    public static Labyrinthe lire( Scanner entrees ) {
        ...
        if( nbColonne <= 0 ) {
            System.err.println( "labyrinthe.model.Labyrinthe::labyrinthe.model.Labyrinthe : Le nombre de colonne doit etre une valeur plus grande que 0.");
            System.exit( -1 );
        }

        int nbLigne = Lecteurs.lireEntier( entrees );
        if( nbLigne <= 0 ) {
            System.err.println( "labyrinthe.model.Labyrinthe::labyrinthe.model.Labyrinthe : Le nombre de ligne doit etre une valeur plus grande que 0.");
            System.exit( -1 );
        }
